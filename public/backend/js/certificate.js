...
$(document).ready(function () {
    ...
    $('.change-input').on('keyup keypress blur change', delay(function (e) {
        console.log('keyup keypress blur change');
        getNew();
    }, 500));
        ...
        if (bgImage.files.length !== 0) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log('Image Loading setBgImage.....');
                    toastr.success( $('#loading').val());
                    getNew();
                }
            });
        }
    ...
    if (fsize > 500000) {
        ...
        if (sigImage.files.length !== 0) {
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend: function () {
                    console.log('Image Uploading setSigImage....');
                },
                success: function (data) {
                    ...
                    console.log('Image Loading setSigImage.....');
                    toastr.success( $('#updated').val());
                    getNew();
                }
            });
