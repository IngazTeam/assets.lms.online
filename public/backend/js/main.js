(function ($) {
    ...
    $('#sidebarCollapse').on('click', function () {
        ...
        $(".side-overlay").toggleClass("sideoverhid");
     });

    $('#close_sidebar').on('click', function () {
        $('#sidebar').removeClass('active');
        $("body").find(".side-overlay").toggleClass("sideoverhid");
    })
    ...
    $(document).click(function (event) {
        if (!$(event.target).closest(".sidebar_icon, .sidebar").length) {
            ...
            $("body").find(".side-overlay").removeClass("sideoverhid");
        }
    });
    ...
    $(document).click(function (event) {
        if (!$(event.target).closest(".sidebar_icon, .sidebar").length) {
            $("body").find(".mm-collapse").removeClass("mm-show");
            $("body").find(".mm-active").removeClass("mm-active");
        }
    });
        ...
        if (check_url != -1) {
            ...
            function myFunction(x) {
                if (x.matches) { // If media query matches
                    $(this).parents().parents().children('ul.mm-collapse').removeClass('mm-show').closest('li').addClass('mm-active');
                } else {
                    $(this).parents().parents().children('ul.mm-collapse').addClass('mm-show').closest('li').addClass('mm-active');
                }
            }
...
function showToastr(data, status){
    if (status == 200) {
