...
var FullCalendar = function (e) {
    ...
    var na = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            var o = this.props, i = this.state, a = i.forceYScrollbars, s = i.scrollerClientWidths,
                l = i.scrollerClientHeights, u = Gi(o, e), c = ji(o, e),
                d = o.liquid ? a ? "scroll" : u ? "auto" : "hidden" : "visible", p = qi(e, r, {
                    tableColGroupNode: n,
                    tableMinWidth: "",
            ...
            return Ar("td", {ref: r.elRef}, Ar("div", {className: "fc-scroller-harness" + (c ? " fc-scroller-harness-liquid" : "")}, Ar(Fi, {
    ...
    },e.triggerDateSelect = In,e.unmountComponentAtNode = zr,e.unpromisify = Mr,e.version = "5.5.0",e.whenTransitionDone = $,e.wholeDivideDurations = tt,Object.defineProperty(e, "__esModule", {value: !0}),e
}({});
