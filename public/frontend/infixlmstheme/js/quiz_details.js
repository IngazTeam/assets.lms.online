...
$(document).ready(function () {
    ...
    $("#next").click(function (e) {
        ...
        if (ans == "undefined" || ans == "" || ans == null) {
            toastr.error( __('common.Please select a option'), __('common.Error'), {
                timeOut: 2000
            });
            return false;
        }
    ...
    $(document).on('click', '.ans', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                toastr.success( __('common.Submit Answer'), __('common.Success'), {
                    timeOut: 2000
                });
            ...
            ,
            error: function (data) {
                toastr.error( __('common.Already Submit Answer'), __('common.Error'), {
                    timeOut: 2000
                });
            }
        });
...
function copyCurrentUrl() {
    ...
    setTimeout(function () {
        toastr.success( __('common.Link Copied Successfully'),__( 'common.Success'), {
            timeOut: 2000
        });
    }, 500);
    //start quiz
