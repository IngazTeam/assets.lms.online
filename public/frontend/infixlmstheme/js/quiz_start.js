...
if (timeArray[0] == 0 && timeArray[1] == 0) {
    toastr.error(__('common.Time not define'), __('common.Failed'));
} else {
    // startTimer();
    ...
    if (ans == "undefined" || ans == "" || ans == null) {
        ...
        if (question_type == 'M') {
            ...
            if (answer_input == "undefined" || answer_input == "" || answer_input == null) {
                toastr.error( __('common.Please Write Answer'), __('common.Error'), {
                    timeOut: 2000
                });
                return false;
            } else {
